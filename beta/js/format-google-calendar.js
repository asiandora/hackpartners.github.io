...
var formatGoogleCalendar = (function() {
    ...
    var transformationList = function(result, tagName, format) {
        ...
        for (i = 0; i < format.length; i++) {
            ...
            if (format[i] === '*summary*') {
                output = output.concat('<span class="summary">' + '<br>' + summary + '</span>');
            } else if (format[i] === '*date*') {
                output = output.concat('<span class="date">' + '<br>' + dateFormatted + '</span>');
            } else if (format[i] === '*description*') {
                output = output.concat('<span class="description">' + '<br>' + description + '</span>');
            } else if (format[i] === '*location*') {
                output = output.concat('<span class="location">' + '<br>' + location + '</span>');
            } else {
    ...
    var formatDateSameDay = function(dateStart, dateEnd, moreDaysEvent, isAllDayEvent, dayNames) {
        ...
        return dateStart[0] + ' ' + getMonthName(dateStart[1]) + ', ' + dateStart[2] + formattedTime;
    };
    ...
    var formatDateDifferentDay = function(dateStart, dateEnd, dayNames) {
      ...
      if (dayNames) {
        ...
        //month day-day, year
        return dateStart[0] + ' - ' + dateEnd[0] + ' ' + getMonthName(dateStart[1]) +  ', ' + dateStart[2];
    };
    ...
    var formatDateDifferentMonth = function(dateStart, dateEnd, dayNames) {
      ...
      if (dayNames) {
        ...
        return dateStart[0] + ' ' + getMonthName(dateStart[1]) + ' - ' + dateEnd[0] + ' ' + getMonthName(dateEnd[1]) + ', ' + dateStart[2];
    };
    ...
    var formatDateDifferentYear = function(dateStart, dateEnd, dayNames) {
      ...
      if (dayNames) {
        ...
        return dateStart[0] + ' ' + getMonthName(dateStart[1]) + ', ' + dateStart[2] + ' - ' + dateEnd[0] + ' ' + getMonthName(dateEnd[1]) + ', ' + dateEnd[2];
    };
